...
// Make sure to returnnew objects with their own memory space.
...
let x = 10; // MEMORY: Variable is x Value is 10
let y = "abc" // MEMORY: Variable is y Value is "abc"

let a = x // MEMORY: Variable is a Value is 10
let b = y

console.log(x, y, a, b)

let arr = [] // This creates an array in memory. Arr receives the address location of that array somewhere in memory.
...
/*
    Array Destructuring allows you to unpack values from arrays, or properties from objects --> into distinct variables
        ...
        * Used to unpack an array/object into distinct variables
*/

let cities = ["Boston", "New York", "Chicago", "LA"]

/*
    JS unpacks the values from cities array and assigns each value 
    its own variable based on their original position in an array
*/
...
let cars = ["Porsche", "BMW", "Maserati", "Aston Martin", 
...
let statesVisited = ["Indiana", "Florida", "Kentucky", "Tennessee", "Utah"]

let statesCountries =[...statesVisited, "Germany", "Spain", "England", "Belgium"]

let [indiana, florida, kentucky, tennessee, utah, ...countries] = statesCountries

console.log(indiana, florida, kentucky, tennessee, utah, countries)