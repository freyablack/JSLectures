...
//console.log("SeasonInfo:", netflix.season1.seasonInfo)
...
console.log("Number:", netflix.season1.seasonInfo.episodeInfo[1].episode);
console.log("Name:", netflix.season1.seasonInfo.episodeInfo[1].episodeName);
